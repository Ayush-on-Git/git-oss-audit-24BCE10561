...
| `LogFile.sh` | Determines the number of times that a keyword is repeated in a log file |
...
All script outputs are included in the project report PDF as required.
